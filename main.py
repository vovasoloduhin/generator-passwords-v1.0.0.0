...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.groupBox.setGeometry(QtCore.QRect(20, 50, 250, 150))
        ...
        self.groupBox_2.setGeometry(QtCore.QRect(520, 50, 250, 150))
        ...
        self.label.setGeometry(QtCore.QRect(360, 70, 120, 30))
        self.label.setText("Пароль:")

        self.lineEdit = QtWidgets.QLineEdit(Form)
        self.lineEdit.setGeometry(QtCore.QRect(295, 100, 200, 30))

        self.pushButton_generate = QtWidgets.QPushButton(Form)
        self.pushButton_generate.setGeometry(QtCore.QRect(295, 150, 200, 40))
        ...
        self.pushButton_add.setGeometry(QtCore.QRect(40, 230, 200, 50))
        ...
        self.pushButton_check.setGeometry(QtCore.QRect(300, 230, 200, 50))
        ...
        self.pushButton_delete.setGeometry(QtCore.QRect(555, 230, 200, 50))
        self.pushButton_delete.setText("Видалити пароль")
        self.pushButton_delete.clicked.connect(self.delete_password)

        self.listWidget = QtWidgets.QListWidget(Form)
        self.listWidget.setGeometry(QtCore.QRect(140, 300, 510, 100))
